...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\n\r\n\r\nconst render = (index, parent) => {\r\n  const response = [\r\n    {\r\n      types: 'success',\r\n      message: 'Your e-mail has been added successfully added',\r\n    },\r\n    {\r\n      types: 'error',\r\n      message: 'Something went wrong! Please try again',\r\n    },\r\n    {\r\n      types: 'error',\r\n      message: 'Please Provide your e-mail',\r\n    },\r\n  ];\r\n\r\n  const text = `\r\n    <div class=\"alert-box alert-box--${response[index].types}\">\r\n        <p>${response[index].message}.</p>\r\n        <i class=\"fa fa-times alert-box__close\" id=\"target\"></i>\r\n    </div>    \r\n  `;\r\n\r\n  parent.insertAdjacentHTML('beforeend', text);\r\n\r\n  const target = document.querySelectorAll('#target');\r\n  target.forEach((el) =>\r\n    el.addEventListener('click', () => (el.parentNode.style.display = 'none'))\r\n  );\r\n};\r\n\r\nconst checkNewsletter = () => {\r\n  //) Get the newsletter Button and add the event listener\r\n  const newsLetter = document.getElementsByName('subscribe');\r\n\r\n  if (newsLetter.length > 0) {\r\n    newsLetter[0].addEventListener('click', async () => {\r\n      //* Get the e-mail\r\n      const email = document.getElementsByName('EMAIL')[0].value;\r\n      const form = document.getElementById('mc-form');\r\n\r\n      //* Check if there is an email\r\n      if (!email) {\r\n        return render(2, form);\r\n      }\r\n\r\n      //* Send the e-mail to the database\r\n      try {\r\n        const res = await axios__WEBPACK_IMPORTED_MODULE_0___default().post('/api/v1/newsLetter/addNewsLetter', {\r\n          email,\r\n        });\r\n\r\n        const success = res.status === 201;\r\n        success ? render(0, form) : render(1, form);\r\n      } catch (error) {\r\n        render(1, form);\r\n      }\r\n    });\r\n  }\r\n};\r\n\r\ncheckNewsletter();\r\n\n\n//# sourceURL=webpack://template/./dist/index.js?");
